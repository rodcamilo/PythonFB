...
tree.left.left.left.left=TreeNode(16)
tree.left.left.left.right=TreeNode(17)
tree.left.left.right.left=TreeNode(18)
tree.left.left.right.right=TreeNode(19)
tree.right.right.left.left=TreeNode(20)
tree.right.right.left.right=TreeNode(21)
tree.right.right.right.left=TreeNode(22)
tree.right.right.right.right=TreeNode(23)
